...
public class ImagePagerAdapter extends BaseAdapter {
	...
	public ImagePagerAdapter(Context context, List<String> imageIdList,
		...
		options = new DisplayImageOptions.Builder()
				...
				.showImageForEmptyUri(R.mipmap.ic_ceshi_girl) // 设置图片Uri为空或是错误的时候显示的图片
				.showImageOnFail(R.mipmap.ic_ceshi_girl) // 设置图片加载或解码过程中发生错误显示的图片
	...
	public View getView(final int position, View view, ViewGroup container) {
		...
		holder.imageView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Toast.makeText(context, "点击了第" + getPosition(position) + "张广告",Toast.LENGTH_SHORT
						).show();
